...
w06 <- mutate(w05, Year = 2006)
w07 <- mutate(w05, Year = 2007)
w08 <- mutate(w05, Year = 2008)
w09 <- mutate(w05, Year = 2009)
w10 <- mutate(w05, Year = 2010)
w11 <- mutate(w05, Year = 2011)
w12 <- mutate(w05, Year = 2012)
w13 <- mutate(w05, Year = 2013)
w14 <- mutate(w05, Year = 2014)
w15 <- mutate(w05, Year = 2015)
w16 <- mutate(w05, Year = 2016)
w17 <- mutate(w05, Year = 2017)
w18 <- mutate(w05, Year = 2018)
w19 <- mutate(w05, Year = 2019)
